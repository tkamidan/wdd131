export function submittedTemplate(name, participants, fees) {
    return `<p>Thank you ${name} for registering. You have registered ${participants} participants and owe ${fees} in fees.</p>`
}
